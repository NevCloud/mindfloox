...
<div class="page">
    ...
    <div class="content">
        ...
        <!-- Logo -->
        <div class="logo">
            <img src="{{ public_path('img/logo-mindflux.png') }}">
        </div>
        ...
        <div class="desc">
            ...
            has successfully completed all learning activities in the
        ...
        <div class="desc">
            ...
            This certificate is awarded as recognition of the participant's
            dedication and successful completion of every course contained in
            this program.
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td width="33%" align="left">
                    ...
                    <div style="font-size:42px;font-weight:bold;color:#183153;margin-top:10px;">
            ...
            <tr>
                ...
                <td width="25%">
                    ...
                    <div class="qr">
                        ...
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data={{ urlencode(route('verify.sertifikat', $sertifikat->nomor_sertifikat)) }}">
                ...
                <td width="25%" class="signature">
                    ...
                    <img src="{{ public_path('img/ttd-direktur.png') }}">
            ...
            <tr>
                ...
                <td width="20%">
                    ...
                    @php
                        ...
                        $qrContent = "Diikuti oleh: {$namaPeserta}\nNomor Sertifikat: {$nomorSertifikat}\n{$namaProgram}\n";
                    @endphp
