                ...
                <div class="flex-1 overflow-y-auto p-5 space-y-5">
                    ...
                    <section>
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="{{ route('peserta.kursus.show', $tugas->id_kursus) }}" class="flex items-center gap-2 px-3 py-1.5 border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 hover:text-primary dark:hover:bg-gray-800 dark:hover:text-primary transition-all">
