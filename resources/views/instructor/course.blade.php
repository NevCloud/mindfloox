                ...
                <div class="flex-1 overflow-y-auto p-5 space-y-5">
                    ...
                    <section class="space-y-5">
                        ...
                        <div class="card translate-0 rounded-2xl overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700"
                            ...
                            <!-- HEADER -->
                            <div
                                class="w-full flex items-center justify-between px-5 py-4 bg-white dark:bg-[#1A1A2E] border-b border-gray-200 dark:border-gray-700">

                                <!-- LEFT (klik untuk toggle) -->
                                ...
                                <!-- RIGHT (tidak trigger toggle) -->
                                <div class="flex items-center gap-3">

                                    <!-- Upload -->
                                    <a href="/upload-materi" @click.stop
