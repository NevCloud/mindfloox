        ...
        <section class="px-4 py-16 text-center">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
                ...
                <div class="relative w-full sm:max-w-xs">
                    ...
                    <input
                        class="h-10 w-full p-5 rounded-full border border-gray-300 transition-all focus:border-primary focus:ring-2 focus:ring-blue-600/20 outline-none dark:bg-gray-800 dark:border-gray-700 "
                    ...
                    <div class="card group">
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            ...
                            <div class="flex gap-4 items-center justify-center mt-auto">
                                ...
                                {{-- Twitter/X --}}
                                <a href="#" class="w-9 h-9 flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:border-primary hover:text-primary transition">
