    ...
    <div class="relative overflow-hidden rounded-2xl px-8 py-6 flex items-center justify-between" style="background-color:#6C63FF">
        <div class="z-10 relative">
            ...
            <div class="flex items-center gap-3">
                <a href="/super-admin/admin" class="bg-white font-semibold text-sm px-5 py-2 rounded-lg hover:-translate-y-0.5 transition duration-200" style="color:#6C63FF">
                    Kelola Pengguna
                </a>
                <a href="/super-admin/program" class="border border-white/40 text-white font-medium text-sm px-5 py-2 rounded-lg hover:bg-white/10 transition duration-200 inline-block">
                    Kelola Program
                </a>
            </div>
        </div>
