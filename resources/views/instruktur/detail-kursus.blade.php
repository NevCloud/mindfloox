                ...
                <div class="p-5 space-y-5">
                    ...
                    <section class="space-y-5" x-data="courseManager()">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-3">
                            ...
                            <div class="hidden md:flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 bg-white dark:bg-[#1A1A2E] px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700">
                                ...
                                <div x-show="week.open" x-transition class="border-t border-gray-200 dark:border-gray-700 p-5 space-y-3 bg-gray-50/50 dark:bg-[#14142B]/50">
                                    ...
                                    <template x-for="(item, index) in week.items" :key="item.id">
                                        <div class="flex flex-col">
                                            ...
                                            {{-- MATERI CARD --}}
                                            <div class="materi-card p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1A1A2E] hover:shadow-md transition">
            ...
            return {
                ...
                saveEditWeek() {
                    ...
                    if (week && this.editTitle.trim()) {
                        ...
                        this.cancelEditWeek();
                        // Di sini nanti bisa ditambahkan API call untuk simpan ke backend
                    }
                },
