<div class="space-y-6">
    ...
    <div @if($lockedTipe) style="display:none" @endif>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            @foreach([
                ['value'=>'dokumen','label'=>'Dokumen','icon'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                ...
                ['value'=>'tugas',  'label'=>'Tugas',   'icon'=>'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z'],
                ['value'=>'kuis',   'label'=>'Kuis',    'icon'=>'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
            ] as $opt)
    ...
    <div>
        ...
        <input type="text" name="judul" x-model="judulMateri"
                        ...
                        <div @click="q.open = !q.open" class="flex items-center gap-3 cursor-pointer flex-1">
                            ...
                            <div>
                                ...
                                <p class="text-xs truncate max-w-[200px]"
                                    ...
                                    x-text="q.type === 'multiple_choice' && !q.answer ? 'Belum ada jawaban benar' : (q.question || 'Belum ada pertanyaan')"></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-1">
                            <button type="button" @click="duplicateQuestion(q.id)" class="w-7 h-7 flex items-center justify-center rounded text-gray-400 hover:text-blue-500 transition">
                            ...
                            <button type="button" @click="q.open = !q.open" class="w-7 h-7 flex items-center justify-center">
                        ...
                        <template x-if="q.type === 'multiple_choice'">
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span x-show="q.answer" class="text-xs text-green-600 dark:text-green-400 flex items-center gap-1">
