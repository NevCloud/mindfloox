...
<head>
    ...
    <title>Periode Akademik - Super Admin</title>
        ...
        <div class="flex-1 overflow-y-auto">
            <div class="p-5 space-y-5">
                ...
                <div class="flex items-center justify-between mb-5">
                    <div>
                        <h1 class="text-xl font-bold text-gray-800 dark:text-white">Periode Akademik</h1>
                        <p class="text-sm text-gray-500 mt-1">Kelola data periode akademik</p>
                    </div>
                </div>
                ...
                <div class="card translate-0 p-5">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="flex-1 flex items-center gap-2 bg-white dark:bg-[#0F0F1A] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 transition-all duration-300 focus-within:ring-2 focus-within:ring-primary focus-within:border-transparent">
                            ...
                            <input type="text" placeholder="Cari periode akademik..." class="flex-1 bg-transparent border-0 outline-none text-sm text-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 w-full py-0.5">
                        </div>
                        <button
                        ...
                        <table class="w-full text-sm text-left whitespace-nowrap">
                            <thead>
                                <tr class="border-b border-gray-200 dark:border-gray-800">
                                    ...
                                    <th class="py-3 px-4 text-xs font-medium text-gray-500 uppercase">Nama Periode</th>
                            ...
                            <tbody class="text-gray-800 dark:text-gray-300">
                                <tr
                                    ...
                                    <td class="py-3 px-4 font-medium">Periode Ganjil 2024/2025</td>
                                    <td class="py-3 px-4 text-gray-500">Semester Ganjil</td>
                                    <td class="py-3 px-4 text-gray-500">2024-09-01</td>
                                    <td class="py-3 px-4 text-gray-500">2024-12-31</td>
                                    <td class="py-3 px-4">
                                        <span
                                ...
                                <tr
                                    ...
                                    <td class="py-3 px-4 font-medium">Periode Genap 2023/2024</td>
                                    <td class="py-3 px-4 text-gray-500">Semester Genap</td>
                                    <td class="py-3 px-4 text-gray-500">2024-01-15</td>
                                    <td class="py-3 px-4 text-gray-500">2024-06-30</td>
                                    <td class="py-3 px-4">
                                        <span
                                            class="px-2 py-1 bg-gray-100 dark:bg-gray-500/10 text-gray-600 dark:text-gray-400 text-xs font-medium rounded-full">Selesai</span>
                                    </td>
                                    <td class="py-3 px-4">
                                        <div class="flex justify-center gap-1">
                                            <button class="group w-9 h-9 flex items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-500/10 text-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-200">
