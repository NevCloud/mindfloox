                ...
                <div class="card translate-0 p-5">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="flex-1 flex items-center gap-2 bg-white dark:bg-[#0F0F1A] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 transition-all duration-300 focus-within:ring-2 focus-within:ring-primary focus-within:border-transparent">
                            ...
                            <input type="text" placeholder="Cari admin atau instruktur..." class="flex-1 bg-transparent border-0 outline-none text-sm text-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 w-full py-0.5">
                        </div>
                        <select
                        ...
                        <table class="w-full text-sm text-left whitespace-nowrap">
                            ...
                            <tbody class="text-gray-800 dark:text-gray-300">
                                <tr
                                    ...
                                    <td class="py-3 px-4 text-gray-500">budi@example.com</td>
                                    <td class="py-3 px-4">
                                        <span
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex items-center gap-3">
                                            <img src="https://i.pravatar.cc/40?img=12" class="w-8 h-8 rounded-full"
                                                alt="">
                                            <span class="font-medium">Sarah Wijaya</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-4 text-gray-500">sarah@example.com</td>
                                    <td class="py-3 px-4">
                                        <span
